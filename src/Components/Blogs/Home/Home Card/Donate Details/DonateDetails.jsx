...
const DonateDetails = () => {
    ...
    console.log(donation)
       ...
       const handleAlert=()=>{
        swal("Congratulations!", "You Donated!", "success");
       }
    ...
    return (
        ...
        <div className="mt-5 relative">
           ...
           <div className="absolute top-80 rounded-lg bg-[#0B0B0B80] w-[1120px] mx-auto py-5   lg:ml-12">
                 <button onClick={handleAlert} className="py-2 px-4 ml-10 rounded-lg text-white" style={{ backgroundColor: button_color }}> Donate ${price}</button>
           </div>
        </div>
    );
};
